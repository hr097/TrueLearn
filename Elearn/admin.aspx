<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="Elearn.admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	<title>Admin | TrueLearn</title>
</asp:Content>
     ...
     <div class="wrapper">
		...
		<div class="sidebar__inner">
			...
			<ul class="siderbar_menu">
				<li>
					<a href="admin.aspx" class="active"> <b></b> <b></b>
        ...
        <div class="main_container">
			...
			<div class="container main_sec">
				<div class="row text-center">
					<div class="col-lg-3">
						<div class="counter active"> <i class="fa-solid fa-user"></i>
		...
		<form runat="server" style="width:100%;">
			<div class="container table-wrapper">
				<div class="table-content">
					<div class="row">
						<div class="col-lg-12">
							<asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="10" GridLines="Horizontal" ShowHeaderWhenEmpty="True" ForeColor="Black" OnRowDeleting="GridView1_RowDeleting" CssClass="grid" >
                                <Columns>
                                    <asp:ButtonField CommandName="delete" HeaderText="delete" ShowHeader="True" ButtonType="Image" ImageUrl="~/Assets/bin.png" />
                                </Columns>
